...
public class BusinessmanBehavior : MonoBehaviour
{
    [System.Serializable]
    ...
    [Header("NPC Brain")]
    public SentenceSimilarity BusinessmanBrain;

    [Header("Businessman list of responses")]
    ...
    void Awake()
    {
        foreach (BusinessmanBehavior.Actions actions in responsesList)
        {
    ...
    {
        Tuple<int, float> tuple_ = BusinessmanBrain.RankSimilarityScores(prompt, sentencesArray);
        Debug.Log("Max score: " + tuple_.Item2 + " Index: " + tuple_.Item1);
